...
{
	SDL_Rect rect = { (int)Shape::GetPosition().x, (int)Shape::GetPosition().y, (int)_size.x, (int)_size.y };
...
void Rectangle::Update(float deltaTime)
{
	...
	case MoveDirection::LEFT:
		SetPosition(Shape::GetPosition() + Vector2(-50, 0) * deltaTime);
		break;
	case MoveDirection::RIGHT:
		SetPosition(Shape::GetPosition() + Vector2(50, 0) * deltaTime);
		break;
	case MoveDirection::UP:
		SetPosition(Shape::GetPosition() + Vector2(0, -50) * deltaTime);
		break;
